...
const u8 gText_BirchInTrouble[] = _("Choose a partner!");
...
const u8 gText_SomeonesPC[] = _("STORAGE POCKET");
const u8 gText_LanettesPC[] = _("LANETTE'S PC");
const u8 gText_PlayersPC[] = _("{PLAYER}'s POCKET");
const u8 gText_HallOfFame[] = _("HALL OF FAME");
const u8 gText_LogOff[] = _("CLOSE SACK");
...
const u8 gText_InfRepelEnabled[] = _("Infinite Repel enabled.{PAUSE_UNTIL_PRESS}");
const u8 gText_InfRepelDisabled[] = _("Infinite Repel disabled.{PAUSE_UNTIL_PRESS}");
const u8 gText_YourPartyWasHealed[] = _("Your party was fully healed!{PAUSE_UNTIL_PRESS}");
const u8 gText_UtilitiesScientistIntro[] = _("Hehe which experiment do you require?");
...
const u8 gText_UtilitiesScientist_Decline[] = _("Coward!");
