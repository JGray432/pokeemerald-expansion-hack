...
{
    { MAP_NUM(ROUTE110), MAP_NUM(ROUTE111), MAP_NUM(ROUTE7),  MAP_NUM(ROUTE134), ___ },
    { MAP_NUM(ROUTE111), MAP_NUM(ROUTE110), MAP_NUM(ROUTE7),  ___, ___ },
    { MAP_NUM(ROUTE7), MAP_NUM(ROUTE111), MAP_NUM(ROUTE110),  ___, ___ },
    {  MAP_NUM(ROUTE7), MAP_NUM(ROUTE110), MAP_NUM(ROUTE111), MAP_NUM(ROUTE119), MAP_NUM(ROUTE123) },
