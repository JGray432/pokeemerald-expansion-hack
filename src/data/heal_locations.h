...
{
    [HEAL_LOCATION_ARCHI_TOWN_ATHENAS_HOUSE - 1] = {MAP_GROUP(ARCHI_TOWN_ATHENAS_HOUSE), MAP_NUM(ARCHI_TOWN_ATHENAS_HOUSE), 5, 6},
    [HEAL_LOCATION_DELPHI - 1] = {MAP_GROUP(DELPHI), MAP_NUM(DELPHI), 21, 16},
    [HEAL_LOCATION_SLATEPORT_CITY - 1] = {MAP_GROUP(SLATEPORT_CITY), MAP_NUM(SLATEPORT_CITY), 19, 20},
    [HEAL_LOCATION_ATHENS - 1] = {MAP_GROUP(ATHENS), MAP_NUM(ATHENS), 22, 4},
    ...
    [HEAL_LOCATION_CRETE - 1] = {MAP_GROUP(CRETE), MAP_NUM(CRETE), 2, 8},
    ...
    [HEAL_LOCATION_VERDANTURF_TOWN - 1] = {MAP_GROUP(VERDANTURF_TOWN), MAP_NUM(VERDANTURF_TOWN), 14, 3},
