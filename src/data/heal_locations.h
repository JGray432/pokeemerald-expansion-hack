...
{
    [HEAL_LOCATION_LITTLEROOT_TOWN_ATHENAS_HOUSE - 1] = {MAP_GROUP(LITTLEROOT_TOWN_ATHENAS_HOUSE), MAP_NUM(LITTLEROOT_TOWN_ATHENAS_HOUSE), 5, 6},
    ...
    [HEAL_LOCATION_CRETE - 1] = {MAP_GROUP(CRETE), MAP_NUM(CRETE), 2, 11},
