...
static const struct HealLocation sHealLocationsPokemonCenter[HEAL_LOCATION_COUNT - 1] =
{
    ...
    [HEAL_LOCATION_ATHENS - 1] =
    {
        .group = MAP_GROUP(ATHENS_POKEMON_CENTER_1F),
        .map = MAP_NUM(ATHENS_POKEMON_CENTER_1F),
        DEFAULT_POKEMON_CENTER_COORDS,
    },
    ...
    [HEAL_LOCATION_CRETE - 1] =
    {
        .group = MAP_GROUP(CRETE_POKEMON_CENTER_1F),
        .map = MAP_NUM(CRETE_POKEMON_CENTER_1F),
        DEFAULT_POKEMON_CENTER_COORDS,
    },
