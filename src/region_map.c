...
{
    [MAPSEC_LITTLEROOT_TOWN] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), HEAL_LOCATION_LITTLEROOT_TOWN_ATHENAS_HOUSE},
...
u32 FilterFlyDestination(struct RegionMap* regionMap)
{
    ...
    case MAPSEC_LITTLEROOT_TOWN:
        return HEAL_LOCATION_LITTLEROOT_TOWN_ATHENAS_HOUSE;
    case MAPSEC_EVER_GRANDE_CITY:
