...
static const u16 sRegionMap_SpecialPlaceLocations[][2] =
{
    ...
    {MAPSEC_ENTOMO_WOODS,            MAPSEC_ROUTE_104},
    ...
    {MAPSEC_ALTERING_CAVE,              MAPSEC_DIONYSUS_VINEYARD},
    {MAPSEC_ARTISAN_CAVE,               MAPSEC_DIONYSUS_VINEYARD},
    {MAPSEC_ABANDONED_SHIP,             MAPSEC_ROUTE_4},
...
static const u16 sTerraOrMarineCaveMapSecIds[ABNORMAL_WEATHER_LOCATIONS] =
{
    ...
    [ABNORMAL_WEATHER_ROUTE_8_NORTH - 1] = MAPSEC_ROUTE_8,
    [ABNORMAL_WEATHER_ROUTE_8_SOUTH - 1] = MAPSEC_ROUTE_8,
    [ABNORMAL_WEATHER_ATHENS_OUTSKIRTS_EAST  - 1] = MAPSEC_ATHENS_OUTSKIRTS,
    [ABNORMAL_WEATHER_ATHENS_OUTSKIRTS_WEST  - 1] = MAPSEC_ATHENS_OUTSKIRTS,
...
{
    [MAPSEC_ARCHI_TOWN] = {MAP_GROUP(ARCHI_TOWN), MAP_NUM(ARCHI_TOWN), HEAL_LOCATION_ARCHI_TOWN_ATHENAS_HOUSE},
    [MAPSEC_OLDALE_TOWN] = {MAP_GROUP(OLDALE_TOWN), MAP_NUM(OLDALE_TOWN), HEAL_LOCATION_OLDALE_TOWN},
    [MAPSEC_CRETE] = {MAP_GROUP(CRETE), MAP_NUM(CRETE), HEAL_LOCATION_CRETE},
    ...
    [MAPSEC_DELPHI] = {MAP_GROUP(DELPHI), MAP_NUM(DELPHI), HEAL_LOCATION_DELPHI},
    [MAPSEC_SLATEPORT_CITY] = {MAP_GROUP(SLATEPORT_CITY), MAP_NUM(SLATEPORT_CITY), HEAL_LOCATION_SLATEPORT_CITY},
    [MAPSEC_ATHENS] = {MAP_GROUP(ATHENS), MAP_NUM(ATHENS), HEAL_LOCATION_ATHENS},
    ...
    [MAPSEC_DIONYSUS_VINEYARD] = {MAP_GROUP(DIONYSUS_VINEYARD), MAP_NUM(DIONYSUS_VINEYARD), HEAL_LOCATION_NONE},
    ...
    [MAPSEC_ROUTE_4] = {MAP_GROUP(ROUTE4), MAP_NUM(ROUTE4), HEAL_LOCATION_NONE},
    ...
    [MAPSEC_ATHENS_OUTSKIRTS] = {MAP_GROUP(ATHENS_OUTSKIRTS), MAP_NUM(ATHENS_OUTSKIRTS), HEAL_LOCATION_NONE},
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_ARCHI_TOWN:
        return FlagGet(FLAG_VISITED_ARCHI_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_OLDALE_TOWN:
        return FlagGet(FLAG_VISITED_OLDALE_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_CRETE:
        return FlagGet(FLAG_VISITED_CRETE) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    ...
    case MAPSEC_DELPHI:
        return FlagGet(FLAG_VISITED_DELPHI) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_SLATEPORT_CITY:
        return FlagGet(FLAG_VISITED_SLATEPORT_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_ATHENS:
        return FlagGet(FLAG_VISITED_ATHENS) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
...
static void CreateFlyDestIcons(void)
{
    ...
    canFlyFlag = FLAG_VISITED_ARCHI_TOWN;
    for (mapSecId = MAPSEC_ARCHI_TOWN; mapSecId <= MAPSEC_EVER_GRANDE_CITY; mapSecId++)
    {
...
u32 FilterFlyDestination(struct RegionMap* regionMap)
{
    ...
    case MAPSEC_ARCHI_TOWN:
        return HEAL_LOCATION_ARCHI_TOWN_ATHENAS_HOUSE;
    case MAPSEC_EVER_GRANDE_CITY:
