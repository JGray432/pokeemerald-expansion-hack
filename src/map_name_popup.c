...
{
    [MAPSEC_ARCHI_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_OLDALE_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_CRETE] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_DELPHI] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_SLATEPORT_CITY] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_ATHENS] = MAPPOPUP_THEME_MARBLE,
    ...
    [MAPSEC_DIONYSUS_VINEYARD] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_ATHENS_OUTSKIRTS] = MAPPOPUP_THEME_WOOD,
...
{
    [MAPSEC_ARCHI_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_OLDALE_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_CRETE] = MAPPOPUP_THEME_BW_DEFAULT,
    ...
    [MAPSEC_DELPHI] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_SLATEPORT_CITY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ATHENS] = MAPPOPUP_THEME_BW_DEFAULT,
    ...
    [MAPSEC_DIONYSUS_VINEYARD] = MAPPOPUP_THEME_BW_DEFAULT,
    ...
    [MAPSEC_ATHENS_OUTSKIRTS] = MAPPOPUP_THEME_BW_DEFAULT,
    ...
    [MAPSEC_LABYRINTH] = MAPPOPUP_THEME_BW_DEFAULT,
