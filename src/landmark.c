...
static const u8 LandmarkName_NewMauville[] = _("NEW ATHENS");
...
static const struct Landmark Landmark_NewMauville = {LandmarkName_NewMauville, FLAG_LANDMARK_NEW_ATHENS};
