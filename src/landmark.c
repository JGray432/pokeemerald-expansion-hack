...
static const u8 LandmarkName_EntomoWoods[] = _("ENTOMO WOODS");
...
static const u8 LandmarkName_NewAthens[] = _("NEW ATHENS");
...
static const u8 LandmarkName_Labyrinth[] = _("GRANITE CAVE");
...
static const struct Landmark Landmark_EntomoWoods = {LandmarkName_EntomoWoods, -1};
...
static const struct Landmark Landmark_NewAthens = {LandmarkName_NewAthens, FLAG_LANDMARK_NEW_ATHENS};
...
static const struct Landmark Landmark_Labyrinth = {LandmarkName_Labyrinth, -1};
...
static const struct Landmark *const Landmarks_DionysusVineyard_2[]  =
{
...
static const struct Landmark *const Landmarks_Route6_1[]  =
{
    &Landmark_Labyrinth,
    NULL,
};
...
static const struct Landmark *const Landmarks_Route8_1[]  =
{
...
static const struct Landmark *const Landmarks_Route8_2[]  =
{
    &Landmark_RusturfTunnel,
    NULL,
};

static const struct Landmark *const Landmarks_Route7_2[]  =
{
...
static const struct LandmarkList sLandmarkLists[] =
{
    ...
    {MAPSEC_ROUTE_8, 1, Landmarks_Route8_1},
    {MAPSEC_ROUTE_8, 2, Landmarks_Route8_2},
    {MAPSEC_ROUTE_7, 2, Landmarks_Route7_2},
