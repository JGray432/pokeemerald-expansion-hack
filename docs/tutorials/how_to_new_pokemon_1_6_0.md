...
Now Mewthree really does slumber in the games code - but we won't know until we make him appear somewhere! The legend tells that Mewthree is hiding somewhere in Entomo Woods...
...
```diff
         {
           "map": "MAP_ENTOMO_WOODS",
           "base_label": "gEntomoWoods",
           "land_mons": {
             "encounter_rate": 20,
             "mons": [
               {
