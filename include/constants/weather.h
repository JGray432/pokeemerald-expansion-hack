...
#define ABNORMAL_WEATHER_ROUTE_8_NORTH    (TERRA_CAVE_LOCATIONS_START + 4)
#define ABNORMAL_WEATHER_ROUTE_8_SOUTH    (TERRA_CAVE_LOCATIONS_START + 5)
#define ABNORMAL_WEATHER_ATHENS_OUTSKIRTS_EAST     (TERRA_CAVE_LOCATIONS_START + 6)
#define ABNORMAL_WEATHER_ATHENS_OUTSKIRTS_WEST     (TERRA_CAVE_LOCATIONS_START + 7)
